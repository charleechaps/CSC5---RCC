//Diana "Charlie" Cardenas               CSC5              Chapter 9, P. 537, #2
//
/*******************************************************************************
 *
...
int main()
{
    ...
    SelectionSort(testScores, numOfTests);
    
    //Find Average
    average = CalcAverage(testScores, numOfTests);
...
void SelectionSort(float *test, int max)
{
    //Variables
    int startScan;
    int minIndex;
...
float CalcAverage(float *test, int testNum)
{
    //Variables
    float total;
    float average;
